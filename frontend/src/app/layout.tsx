...
export const metadata: Metadata = {
  ...
  description: "Khám phá bộ sưu tập đồ dùng cho bé với chất liệu an toàn, thiết kế xinh xắn. Quần áo, đồ chơi, xe đẩy, và nhiều sản phẩm chất lượng cao dành cho bé yêu của bạn.",
  keywords: ["baby products", "sản phẩm cho bé", "quần áo trẻ em", "đồ chơi trẻ em", "xe đẩy", "bình sữa", "tã bỉm"],
